 ...
 * NOR Flash size in bytes
 */
#define MCU_FLASH_SIZE    (UINT32_C(512) * 1024)

/**
 * SRAM base address
 */
#define MCU_SRAM_BASE_ADDR    UINT32_C(0x1FFF8000)

/**
 * SRAM size in bytes
 */
#define MCU_SRAM_SIZE    (UINT32_C(128) * 1024)
 ...
 * CPU clock frequency in MHz
 */
#define MCU_CPU_CLOCK_FREQ_IN_MHZ  UINT32_C(72)
 ...
 * SRAM base address
 */
#define MCU_SRAM_BASE_ADDR    UINT32_C(0x20000000)

/**
 * SRAM size in bytes
 */
#define MCU_SRAM_SIZE    (UINT32_C(96) * 1024)
