...
/**
 * Atomically "and" the 32-bit value stored in *counter_p with 'value',
 ...
 */
uint32_t
atomic_fetch_and_uint32(volatile uint32_t *counter_p, uint32_t value)
{
#if (__CORTEX_M >= 0x03)
    uint32_t old_value;
...
/**
 * Atomically "or" the 32-bit value stored in *counter_p with 'value',
 * and returns the original value.
 *
 * @param   counter_p: Pointer to the counter to be incremented.
 *
 ...
 */
uint32_t
atomic_fetch_or_uint32(volatile uint32_t *counter_p, uint32_t value)
{
#if (__CORTEX_M >= 0x03)
    uint32_t old_value;
...
/**
 * Atomically "xor" the 32-bit value stored in *counter_p with 'value',
 * and returns the original value.
 *
 * @param   counter_p: Pointer to the counter to be incremented.
 *
 ...
 */
uint32_t
atomic_fetch_xor_uint32(volatile uint32_t *counter_p, uint32_t value)
{
#if (__CORTEX_M >= 0x03)
    uint32_t old_value;
